  ...
  return (
    ...
    <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px]'>
        <img
            ...
            className='object-scape-up h-full hover:scale-110 transition-all'
            alt={product?.productName} // Don't forget to add an alt attribute for accessibility
        />
    </div>
    <div className='p-4 grid'>
        ...
        <button className=' bg-blue-300 hover:bg-custom-orange text-white px-1 py-3 rounded-full' onClick={(e) => handleAddToCart(e, product?._id)}>Add to Cart</button>
    </div>
</Link>
