                        ...
                        return(
                            <Link
                                ...
                                <div className='bg-slate-100 p-4 grid gap-3'>
                                    ...
                                    <button className='text-sm  bg-blue-600 hover:bg-custom-orange text-white px-1 py-2  rounded-full ' onClick={(e)=>handleAddToCart(e,product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        )
